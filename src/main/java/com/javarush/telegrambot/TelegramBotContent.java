...
public class TelegramBotContent {
    public static final String STEP_1_TEXT = """
            *ПРИВЕТСТВУЕМ НА ПЕРВОМ УРОВНЕ!*
            ...
            Ты просыпаешься и понимаешь, что ты — кот. Утро доброе, но что это за удивительные чувства? Твой живот урчит от сильного голода. Еды в квартире нет, разве что в закрытом холодильнике. Что же делать?
    ...
    public static final String STEP_3_TEXT = """
            *Кот Айтишник, уровень второй.*
            ...
            Выполни второе задание и взломай пылесос!
            """;

    public static final String STEP_4_TEXT = """
            *ПРИВЕТСТВУЕМ НА ТРЕТЬЕМ УРОВНЕ!*
                                    
            Ты справился с робот-пылесосом! Ты получаешь +30 славы!
    ...
    public static final String STEP_5_TEXT = """
            *Кот Роботоукротитель, уровень третий.*
